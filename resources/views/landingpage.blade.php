...
<html lang="en">
    ...
    <!--Favicon-->
    <link rel="shortcut icon" type="image/png" href="{{asset('user_frontend/images/fav.png')}}"/>
    </head>
    <body>
    ...
    ================================================= -->
        <section id="features">
            <div class="container wrapper">
                ...
                <img src="{{asset('user_frontend/images/face-map.png')}}" alt="" class="img-responsive face-map slideUp hidden-sm hidden-xs" />
            </div>
        ...
        <section id="app-download">
            <div class="container wrapper">
                ...
                <ul class="app-btn list-inline slideUp">
                    <li><button class="btn-secondary"><img src="{{asset('user_frontend/images/app-store.png')}}" alt="App Store" /></button></li>
                    <li><button class="btn-secondary"><img src="{{asset('user_frontend/images/google-play.png')}}" alt="Google Play" /></button></li>
                </ul>
                <h2 class="sub-title">stay connected anytime, anywhere</h2>
                <img src="{{asset('user_frontend/images/iPhone.png')}}" alt="iPhone" class="img-responsive" />
            </div>
        </section>
        ...
        <section id="live-feed">
            <div class="container wrapper">
                ...
                <ul class="online-users list-inline slideUp">
                    <li><a href="#" title="Alexis Clark"><img src="{{asset('user_frontend/images/users/user-5.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="James Carter"><img src="{{asset('user_frontend/images/users/user-6.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Robert Cook"><img src="{{asset('user_frontend/images/users/user-7.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Richard Bell"><img src="{{asset('user_frontend/images/users/user-8.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Anna Young"><img src="{{asset('user_frontend/images/users/user-9.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
          <li><a href="#" title="Julia Cox"><img src="{{asset('user_frontend/images/users/user-10.jpg')}}" alt="" class="img-responsive profile-photo" /><span class="online-dot"></span></a></li>
                </ul>
                <h2 class="sub-title">see what’s happening now</h2>
                <div class="row">
                    <div class="col-md-4 col-sm-6 col-md-offset-2">
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-1.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-4.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-10.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-3.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-2.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-17.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-18.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-11.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
                        ...
                        <div class="feed-item">
                            <img src="{{asset('user_frontend/images/users/user-16.jpg')}}" alt="user" class="img-responsive profile-photo-sm" />
                            <div class="live-activity">
        ...
        <div class="row">
          <div class="footer-wrapper">
            <div class="col-md-3 col-sm-3">
              <a href=""><img src="{{asset('user_frontend/images/logo-black.png')}}" alt="" class="footer-logo" /></a>

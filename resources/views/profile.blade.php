...
<img src="profile/1647338373.jpg" class="img-responsive profile-photo" >
...
<li><a href="edit-profile.php">Timeline</a></li>
<li><a href="edit-image.php" >Image</a></li>
...
<li class="active"><i class="icon ion-ios-briefcase-outline"></i><a href="edit-profile.php">Basic Information</a></li>
<li><i class="icon ion-ios-heart-outline"></i><a href="edit-image.php">Profile Image</a></li>
...
<form name="education" id="education" class="form-inline" style="margin-top:30px" action="{{route('profile_update',$data->id)}}" method="POST">
...
<input id="date-from" class="form-control input-group-lg" type="text" name="username" placeholder="asad6351" value="{{$data->email}}">
</div>
</div>
<div class="row">
<div class="form-group col-xs-6">
<label for="date-from">First Name</label>
<input id="date-from" class="form-control input-group-lg" type="text" name="firstname" placeholder="Muhammad" value="{{$data->name}}">
</div>
<div class="form-group col-xs-6">
<label for="date-to" class="">Last Name</label>
<input id="date-to" class="form-control input-group-lg" type="text" name="lastname" placeholder="Asad" value="{{$data->last_name}}">
</div>
</div>
<div class="row">
<div class="form-group col-xs-12">
<label for="school">Geburtsdatum</label>
<input id="school" class="form-control input-group-lg" type="text" name="dateofbirth" placeholder="12-10-2012" value="{{$data->dob}}">
</div>
</div>
<div class="row">
<div class="form-group col-xs-12">
<label for="school">Address</label>
<input id="school" class="form-control input-group-lg" type="text" name="residence" placeholder="house 54" value="{{$data->address}}">
</div>
</div>
<div class="row">
<div class="form-group col-xs-12">
<label for="school">Phone</label>
<input id="school" class="form-control input-group-lg" type="text" name="phone" placeholder="+923244218660" value="{{$data->phone}}">
</div>
</div>
<div class="row">
<div class="form-group col-xs-12">
<label for="edu-description">Info</label>
<textarea id="edu-description" name="about" class="form-control" rows="4" cols="400">{{$data->info}}</textarea>
</div>
</div>

<div class="col-md-3 static">
  ...
  <a class="navbar-brand" href="">
    ...
    <img src="{{asset('storage/user_profile_pics/'.Auth::user()->profile_pic)}}" alt="logo" style="width:60px;height:60px;border-radius:50%;margin-top:-10px"></a>
    @else
    <img src="{{asset('storage/user_profile_pics/photoicon.jpg')}}" alt="logo" style="width:60px;height:60px;border-radius:50%;margin-top:-10px"></a>
    @endif

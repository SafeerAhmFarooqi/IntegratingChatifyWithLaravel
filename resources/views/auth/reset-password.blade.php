                  ...
                  @csrf
                     <div class="row">
                      <div class="form-group col-xs-12">
                        ...
                        <input id="email" type="email" class="form-control @error('email') is-invalid @enderror" name="email" value="{{old('email', $request->email)}}" required autocomplete="email"   placeholder="Your Email"/>
                        @error('email')

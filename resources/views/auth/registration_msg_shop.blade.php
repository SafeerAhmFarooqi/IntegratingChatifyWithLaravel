            ...
            <div class="error-content">
              <div class="container">
                ...
                <div class="error-message">
                    <h1 class="error-title">Shop Account Successfully Registered!</h1>
                    <p>You will soon recieve confirmation email</p>
                    <p>
                        <a  href="Shop/login">Return to Shop Login Screen</a>
                    </p>
